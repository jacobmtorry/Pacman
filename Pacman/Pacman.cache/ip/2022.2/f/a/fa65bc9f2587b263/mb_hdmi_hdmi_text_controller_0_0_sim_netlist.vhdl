...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vga_controller is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \addr_a1_carry__0_i_8\ : label is "soft_lutpair97";
...
\addr_a1_carry__0_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
hdmi_text_controller_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_text_controller_v1_0_AXI
     port map (
      ...
      ADDRBWRADDR(5) => vga_n_29,
      ADDRBWRADDR(4) => vga_n_30,
      ADDRBWRADDR(3) => vga_n_31,
      ADDRBWRADDR(2) => vga_n_32,
      ADDRBWRADDR(1) => vga_n_33,
      ADDRBWRADDR(0) => cur_glyph_X(0),
