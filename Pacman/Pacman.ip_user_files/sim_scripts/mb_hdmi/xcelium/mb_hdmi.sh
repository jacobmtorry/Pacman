...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.mb_hdmi \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Pacman.gen/sources_1/bd/mb_hdmi/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Pacman.gen/sources_1/bd/mb_hdmi/ipshared/7698" \
       +incdir+"../../../../Pacman.gen/sources_1/bd/mb_hdmi/ipshared/ec67/hdl" \
       +incdir+"../../../../Pacman.gen/sources_1/bd/mb_hdmi/ipshared/7698" \
       +incdir+"../../../../Pacman.gen/sources_1/bd/mb_hdmi/ip/mb_hdmi_hdmi_text_controller_0_0_1/src/clk_wiz_0" \
       -input simulate.do
}
